                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_size', null, ['class'=> 'form-control','id'=>'kode1','required'=>'required', 'placeholder'=>'Kode Size', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>

                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?php echo e(Form::label('deskripsi', 'Deskripsi:',['class'=>'control-label'])); ?>

                                    <?php echo e(Form::text('deskripsi', null, ['class'=> 'form-control','id'=>'deskripsi1','required'=>'required', 'placeholder'=>'Deskripsi', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('kode_size', null, ['class'=> 'form-control','id'=>'kode','required'=>'required','readonly'])); ?>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <?php echo e(Form::text('deskripsi', null, ['class'=> 'form-control','id'=>'deskripsi','required'=>'required', 'placeholder'=>'Deskripsi', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"])); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#editsize').click( function () {
                ...
                $.ajax({
                    url: '<?php echo route('sizetipemaster.edit_size'); ?>',
                    type: 'POST',
                    data : {
                        'id': kode_size
                    },
            ...
            $('#hapussize').click( function () {
                ...
                swal({
                    ...
                    if (e.value === true) {
                        $.ajax({
                            url: '<?php echo route('sizetipemaster.hapus_size'); ?>',
                            type: 'POST',
                            data : {
                                'id': kode_size
                            },
        ...
        $('#ADD').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('sizetipemaster.store'); ?>',
                    type:'POST',
                    data:formData,
        ...
        $('#EDIT').submit(function (e) {
            ...
            var formData = registerForm.serialize();
                ...
                $.ajax({
                    url:'<?php echo route('sizetipemaster.ajaxupdate'); ?>',
                    type:'POST',
                    data:formData,
                    success:function(data) {
                        console.log(data);
