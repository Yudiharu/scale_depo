...
<body onLoad="load()">
        ...
        <div class="col-md-2">
          ...
          <div class="box box-danger box-solid">
            <div class="box-header">
              ...
              <span class="pull-right"> 
                <h3 class="box-title"><font style="font-size: 15px">SPB Cont.</font></h3>
              </span>
            </div>
          </div>
          </a>
        ...
        <div class="col-md-2">
          ...
          <div class="box box-warning box-solid">
            <div class="box-header">
              ...
              <span class="pull-right"> 
                <h3 class="box-title"><font style="font-size: 15px">SPB Non Cont.</font></h3>
              </span>
            </div>
          </div>
          </a>
      ...
      <div class="row">
        ...
        <div class="col-md-3">
          <div class="box box-default collapsed-box">
            <div class="box-header with-border">
                <h3 class="box-title"><font style="font-size: 15px">Job Order Open </font><span class="badge bg-red"></span></h3>
                <div class="box-tools pull-right">
                  <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
                </div>
            </div>
        ...
        <div class="col-md-3">
          <div class="box box-default collapsed-box">
            <div class="box-header with-border">
                <h3 class="box-title"><font style="font-size: 15px">SPB Container Open </font><span class="badge bg-orange"></span></h3>
                <div class="box-tools pull-right">
                  <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
                </div>
            </div>
        ...
        <div class="col-md-3">
          <div class="box box-default collapsed-box">
            <div class="box-header with-border">
                <h3 class="box-title"><font style="font-size: 15px">SPB Non Container Open </font><span class="badge bg-green"></span></h3>
                <div class="box-tools pull-right">
                  <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
                </div>
            </div>
