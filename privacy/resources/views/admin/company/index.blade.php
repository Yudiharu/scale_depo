                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{Form::select('status', ['Aktif' => 'Aktif', 'NonAktif' => 'NonAktif'], null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'Status1','required'=>'required'])}}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('Tipe', 'Tipe:') }}
                                    {{Form::select('tipe', ['Pusat' => 'Pusat', 'Cabang' => 'Cabang'], null, ['class'=> 'form-control','style'=>'width: 100%','placeholder' => '','id'=>'tipe1','required'=>'required','onchange'=>"tipes();"])}}
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="form-group2">
                                    {{ Form::label('kode', 'Kode Company:') }}
                                    {{Form::select('kode_comp', $company, null, ['class'=> 'form-control','style'=>'width: 100%','placeholder'=>'','id'=>'company1','required'=>'required'])}}
                                </div>
                            </div>
                        </div>
                    </div>
