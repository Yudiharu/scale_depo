                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('nama_customer', null, ['class'=> 'form-control','id'=>'nama1','required'=>'required', 'placeholder'=>'Nama Customer', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('no_telepon', 'No Telepon:',['class'=>'control-label']) }}
                                    {{ Form::text('no_telepon', null, ['class'=> 'form-control','id'=>'telepon1','required'=>'required', 'placeholder'=>'No Telepon', 'autocomplete'=>'off','onkeypress'=>"return hanyaAngka(event)"]) }}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('kode_customer', null, ['class'=> 'form-control','id'=>'kode','required'=>'required','readonly']) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('nama_customer', 'Nama Customer:') }}
                                    {{ Form::text('nama_customer', null, ['class'=> 'form-control','id'=>'nama','required'=>'required', 'placeholder'=>'Nama Customer', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    {{ Form::label('no_telepon', 'No Telepon:',['class'=>'control-label']) }}
                                    {{ Form::text('no_telepon', null, ['class'=> 'form-control','id'=>'telepon','required'=>'required', 'placeholder'=>'Tipe Barang', 'autocomplete'=>'off', 'onkeypress'=>"return pulsar(event,this)"]) }}
                                </div>
                            </div>
                        </div>
                    </div>
