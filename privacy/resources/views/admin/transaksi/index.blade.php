    ...
    <div class="box box-solid">
        <div class="box-body">
            <div class="box box-danger">
                <div class="box-body">
                    <a href="{{ $create_url }}" class="btn btn-success btn-xs">New Transaksi</a>
                    <div class="pull-right">
                    <!-- <a href="{{ route('transaksis.laporanExcel') }}" class="btn btn-success btn-xs">Export to Excel</a>
                    <a href="{{ route('transaksis.laporanPDF') }}" class="btn btn-danger btn-xs">Export to PDF</a> -->
